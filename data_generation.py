...
class dataGeneration:
    def __init__(self):
        self.l1 = ['Calories','EX_routine_Id',"Recipe"]
        ...
        self.l10 = ["Email","Id"]
        self.l11 = ["Trainer_Id","Phone_no","Fee","Name"]

    def diet_plan(self,count,ex_routine_min,ex_routine_max,cal_min,cal_max,recipe_min,recipe_max):
        #f1
        result = []
        for i in range(count):
            result.append([r(cal_min,cal_max),'EX_routine'+str(r(ex_routine_min,ex_routine_max)),"Recipe"+str(r(recipe_min,recipe_max))])
        return result
    ...
    def exercise_routine(self,count,duration_min,duration_max,cal_min,cal_max,ex_id_min,ex_id_max):
        ...
        result = [] 
        for i in range(count):
            result.append(['EX_routine'+str(i),r(duration_min,duration_max),r(cal_min,cal_max),"EX_ID"+str(r(ex_id_min,ex_id_max))])
        return result

    def daily_log(self,count,duration_min,duration_max,cal_min,cal_max,cal_consume_min,cal_consume_max,feedback_min,feedback_max,ex_routine_min,ex_routine_max):
        #f3
        result = []
        for i in range(count):
            result.append(["LYL"+str(i),r(duration_min,duration_max),r(cal_min,cal_max),r(cal_consume_min,cal_consume_max),"Feedback"+str(r(feedback_min,feedback_max),),'EX_routine'+str(r(ex_routine_min,ex_routine_max))])
        return result
    ...
    def exercise_list(self,count,description_min,description_max,type_min,type_max):
        ...
        result = []
        for i in range(count):
            result.append(["EX_ID"+str(i),"Description"+str(r(description_min,description_max)),"Type"+str(r(type_min,type_max))])
        return result
    ...
    def loyalty_pts(self,count,streaks_min,streaks_max,Level_min,Level_max,loyalty_min,loyalty_max):
        ...
        result = []
        for i in range(count):
            result.append([r(streaks_min,streaks_max),r(Level_min,Level_max),"LYL"+str(r(loyalty_min,loyalty_max))])
        return result

    def user_info(self,count,height_min,height_max,weight_min,weight_max,Fname_min,Fname_max,Mname_min,Mname_max,Lname_min,Lname_max):
        #f8
        gender_min = 0
        gender_max = 2
        result = []
        for i in range(count):
            result.append(["USR"+str(i),r(gender_min,gender_max),r(height_min,height_max),r(weight_min,weight_max),"Fname"+str(r(Fname_min,Fname_max)),"Mname"+str(r(Mname_min,Mname_max)),"Lname"+str(r(Lname_min,Lname_max))])
        return result

    def membership_type(self,count,period_min,period_max,amount_min,amount_max,user_id_min,user_id_max,trainer_id_min,trainer_id_max):
        #f9
        result = [] 
        for i in range(count):
            result.append(["MEM"+str(i),r(period_min,period_max),r(amount_min,amount_max),"USR"+str(r(user_id_min,user_id_max)),"TRAINER"+str(r(trainer_id_min,trainer_id_max))])
        return result
    ...
    def trainer(self,count,fee_min,fee_max,name_min,name_max,ph_min=1000000000,ph_max=9999999999):
        ...
        result = [] 
        for i in range(count):
            result.append(["TRAINER"+str(i),r(ph_min,ph_max),r(fee_min,fee_max),"TrainerName"+str(r(name_min,name_max))])
        return result
...
if __name__=='__main__':
    ...
    with open(filename,'w') as csvfile:
        ...
        csvwriter.writerows(dataGen.recipe(count=80))
